    ...
    translation: {
      ...
      homeSections: {
        row1: {
          ...
          col2: ["Light", "Up to 25% off Coupon", "Shop Now"],
        },
  ...
  es: {
    translation: {
      ...
      footer: {
        ...
        support: "Soporte",
        address: "Begum Sarani, Daca, DH 1515,India",
